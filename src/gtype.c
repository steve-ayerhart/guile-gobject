...
scm_c_gtype_get_direct_supers (GType type)
{
  ...
  g_debug ("scm_c_gtype_get_direct_supers_end");
...
#include "gtype.x"
  ...
  scm_gtype_name_to_scheme_name =
    scm_permanent_object (scm_variable_ref (scm_c_public_lookup ("g-object utils", "gtype-name->scheme-name")));
  scm_gtype_name_to_class_name =
    scm_permanent_object (scm_variable_ref (scm_c_public_lookup ("g-object utils", "gtype-name->class-name")));
  ...
  g_debug ("scm_gobject_gtype_init_end");
}
